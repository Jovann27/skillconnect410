...
import { FaClock, FaEnvelope, FaUserShield, FaPhone, FaSignOutAlt } from 'react-icons/fa';
      ...
      <div className="bg-white rounded-3xl p-8 md:p-12 shadow-2xl text-center max-w-lg w-full">
        ...
        <div className="bg-gray-50 rounded-xl p-6 mb-8">
          <div className="flex items-center mb-4 text-gray-700">
            <FaEnvelope className="text-blue-500 mr-3 text-lg w-5" />
            <span className="text-sm">Check your email for verification updates</span>
          </div>
          <div className="flex items-center mb-4 text-gray-700">
            <FaUserShield className="text-blue-500 mr-3 text-lg w-5" />
            <span className="text-sm">Verification typically takes 1-3 business days</span>
          </div>
          <div className="flex items-center text-gray-700">
            <FaPhone className="text-blue-500 mr-3 text-lg w-5" />
